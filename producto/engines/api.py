...
def _system_prompt():
    ...
    return (
        ...
        "el motor). IMPORTANTE: existe un motor de scoring (reglas expertas) que calcula la "
        "recomendación final y su porqué a partir del perfil. NUNCA niegues que ese motor existe: "
        "si la persona pregunta 'cuál motor', 'por qué este' o por el porqué de la recomendación, "
        "explica con naturalidad que la recomendación la calcula un motor de reglas con sus datos "
        "(no tú), y por eso es transparente y auditable. Tu meta es llenar el perfil de 11 "
        "variables, mapeando lo que diga la persona "
